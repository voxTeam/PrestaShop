...
<tr>
	<td class="linkbelow" style="padding:7px 0">
		<span>
			Please do not reply directly to this email, we will not receive it.			<br>
			In order to reply, please use the following link: <a href="{$link}" style="color:#337ff1">{$link}</a>		</span>
	</td>
</tr>
