				...
				<td style="padding:7px 0">
					<font size="2" face="Open-sans, sans-serif" color="#555454">
						...
						<span style="color:#777">
							...
							<span style="color:#333"><strong>Discussion history:</strong></span> {$messages}<br /><br />
							<span style="color:#333"><strong>{$employee}</strong></span> added <span style="color:#333"><strong>"{$comment}"</strong></span>
						</span>
					</font>
				</td>
				<td width="10" style="padding:7px 0">&nbsp;</td>
