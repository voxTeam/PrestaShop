				...
				<td style="padding:7px 0">
					<font size="2" face="Open-sans, sans-serif" color="#555454">
						...
						<span style="color:#777">
							Your order with the reference <span style="color:#333"><strong>{$order_name}</strong></span> from <span style="color:#333"><strong>{$shop_name}</strong></span> has been changed by the merchant.						</span>
					</font>
				</td>
				<td width="10" style="padding:7px 0">&nbsp;</td>
			</tr>
